...
public class DNA {
    ...
    public static List<Integer> recombineDNA(List<Integer> dna1, List<Integer> dna2) {
        ...
        int splitpoint1 = ThreadLocalRandom.current().nextInt(0,32-1);
        int splitpoint2 = ThreadLocalRandom.current().nextInt(splitpoint1,32+1);
        List<Integer> dna = new ArrayList<>();
